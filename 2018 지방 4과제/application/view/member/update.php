				...
				<fieldset><legend class="frm_title">Add Member</legend>
					<ul>
						<li>
							<label>
								<strong>아이디</strong>
								<input type="text" name="id" class="fullSize" size="40" placeholder="아이디을(를) 입력해주세요." autofocus="" value="<?php echo $data->id ?>">
							</label>
						</li>
						<li>
							<label>
						...
						<li>
							<label>
								<strong>이름</strong>
								<input type="text" name="name" class="fullSize" size="40" placeholder="이름을 입력해주세요." value="<?php echo $data->name ?>">
							</label>
						</li>
							<label>
								<strong>권한</strong>
